...
interface IconHalfStarRightProps {
  size?: number
  stroke?: number
  color?: string
}
export const IconHalfStarRight: VFC<IconHalfStarRightProps> = ({ size = 15, color, stroke }) => (
  <Svg
